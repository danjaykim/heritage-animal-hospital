export default function IntroMessage() {
    return (
        <section className="containers flex flex-col items-center gap-5 md:gap-8 text-[#1A2954]">
            ...
            <p className="font-light tracking-wide leading-6 md:w-1/2 lg:w-1/3 md:text-center">
