...
export default function UrgentCareMessage() {
    return (
        <section className="bg-[#F5F3EF] w-full pt-[3rem] md:pt-[5rem] lg:pt-[6rem] xl:pt-[5rem] pb-[5rem] lg:pb-0 xl:pb-[8rem]">
            <div className="containers flex flex-col md:flex-row lg:justify-between md:gap-8">
                <div className="h-[23rem] md:min-h-[23rem] lg:min-h-[30rem] xl:min-h-[35rem] md:w-1/2 relative">
                    <img
                        src={emDog}
